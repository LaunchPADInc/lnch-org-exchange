...
var utils = {
  ...
  log(prefix, message) {
    console.log('%LNCH', this.consoleLog, prefix, message);
  },

  warn(prefix, message) {
    console.warn('%LNCH', this.consoleWarn, prefix, message);
  },

  error(prefix, message) {
    console.error('%LNCH', this.consoleError, prefix, message);
  },

  debug(prefix, message) {
    console.log('%LNCH', this.consoleDebug, prefix, message);
  }
};
